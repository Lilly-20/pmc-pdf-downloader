...
一个本地运行的小工具：粘贴 PMID / PMCID / DOI 列表，自动从 **PMC（PubMed Central）** 批量下载**有免费全文**的文献 PDF，按「第一作者 年份 - 标题」自动命名，直接拖进 Zotero 即可。
...
3. 把文献编号粘进文本框，每行一个；选择保存位置，点「开始下载」
4. 下载完成后点「打开文件夹」，把 PDF 拖进 Zotero 对应条目
...
```bash
# 准备 ids.txt，每行一个 PMID / PMCID / DOI
